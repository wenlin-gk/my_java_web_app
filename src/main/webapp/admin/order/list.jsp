...
<HEAD><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <script language="javascript" src="${pageContext.request.contextPath}/admin/layer/layer.js"></script>
  <script type="text/javascript">
    function showDetail(oid){
      $.post("${pageContext.request.contextPath}/admin/order",{"method":"getInJson","oid":oid},function(d){
          ...
          <td class="ta_01" align="center" bgColor="#f5fafe">
            <table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 100%; WORD-BREAK: break-all; BORDER-BOTTOM: gray 1px solid; BORDER-COLLAPSE: collapse; BACKGROUND-COLOR: #f5fafe; WORD-WRAP: break-word">
              ...
              <c:forEach items="${list }" var="o" varStatus="vs">
                <tr id="order_item" onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
                  ...
                  <td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">
                    ...
                    <c:if test="${o.state == 1 }">
                      <a href="${pageContext.request.contextPath }/admin/order?method=updateState&oid=${o.oid}">去发货</a>
                    </c:if>
